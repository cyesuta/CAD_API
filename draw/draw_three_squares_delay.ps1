...
Write-Host "開始繪製三個正方形，每條線延遲1秒..." -ForegroundColor Green
...
Write-Host "Drawing completed - Three squares with delay!" -ForegroundColor Green